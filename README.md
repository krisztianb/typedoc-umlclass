...
* [TypeDoc](https://typedoc.org/) (supported versions: 0.17.x, 0.18.x, 0.19.x or 0.20.14 and above)
...
| Name & Format | Description | Default |
| ------------- | ----------- | ------- |
**generatorProcessCount** `<integer>` | Generating many diagrams can take several minutes. You can use this option to define how many PlantUML JAVA processes should be used to generate the diagrams. The work is evenly scheduled among these processes. To increase the performance of the plugin, it is a good idea to set this value to the number of CPUs that are available. | `1` |
